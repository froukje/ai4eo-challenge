...
python submission.py --raw-data-dir /swork/shared_data/2021-ai4eo/eopatches/ --target-dir /swork/shared_data/2021-ai4eo/dev_data/default/ --input_channels 4 --max-epochs 2 --learning-rate 1e-5
